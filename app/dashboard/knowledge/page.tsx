    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {loading ? (
        ...
        <>
          ...
          {filtered.length === 0 ? (
            <div style={{ background: '#131313', border: '1px solid #2A2A2A', borderRadius: 10, padding: 32, textAlign: 'center', color: '#707070', fontSize: 14 }}>
              No entries match your search.
            </div>
          ) : Object.entries(grouped).map(([pagePath, entries]) => (
            <div key={pagePath} style={{ background: '#131313', border: '1px solid #2A2A2A', borderRadius: 10, overflow: 'hidden' }}>
